...
The platform will also will function as a console in which people from various locations in the world and create and build ideas through collaboration and support each other through elevation. 
...
You'll need to install all the gem files before you can create a profile and use the site. 
Fork this repository and clone it on cloud9 or your IDE of choice and run "bundle install" on your console. 
This will install all the gem files. Then run the application. 

Commit to master repository..

git add -A (This bundles new, modified and deleted files/code ready for commit to your master)

git commit -m "Description of my change" 

git status (Check if there are files not commited)

git push origin master (Save all changes to your github repository)
...
This repo is no longer mentained. Our new site can be found ![here](https://www.yostudent.com/)
