...
You'll need to install all the gem files before you can create a profile and use the site. Fork this repository and clone it on cloud9 or your IDE of choice and run "bundle install" on your console. This will install all the gem files. Then run the application. 
